...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { episodes: @anime.episodes, genre: @anime.genre, likes: @anime.likes, release: @anime.release, title: @anime.title } }, as: :json
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { episodes: @anime.episodes, genre: @anime.genre, likes: @anime.likes, release: @anime.release, title: @anime.title } }, as: :json
    assert_response 200
  end
